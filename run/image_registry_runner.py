...
try:
    ...
    imageRegistry.add_trusted_zone_cert(trusted_zone, ipfs_hash, 'etny-nodenithy', ipfs_docker_compose_hash, os.getenv("ENCLAVE_NAME_TRUSTEDZONE"), 10)
    imageRegistry.add_secure_lock_and_validate_image_cert(secure_lock, ipfs_hash, 'etny-nodenithy', ipfs_docker_compose_hash, os.getenv("ENCLAVE_NAME_SECURELOCK"), 0)
    print("************************")
